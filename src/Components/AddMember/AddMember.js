          ...
          <form>
            <div className="container my-3">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="position" aria-describedby="emailHelp" value={position} onChange={(e) => { setPosition(e.target.value) }} placeholder="Enter position" />
              </div>
