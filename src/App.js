...
import { E } from "./Components/Clubs/E-cell/E-cell";
import { M } from "./Components/Clubs/Mag.com/Mag.com";
import { I } from './Components/Clubs/IVLabs/IVLabs';
      ...
      <div className="main-container">
        <Router>
          ...
          <Switch>
            ...
            <Route exact path="/E-cell">
              {user && user._id ? <E></E> : <Login updateUser={updateUser} />}
            </Route>
            ...
            <Route exact path="/IVLabs">
              {user && user._id ? <I></I> : <Login updateUser={updateUser} />}
            </Route>
            ...
            <Route exact path="/Mag.com">
              {user && user._id ? <M></M> : <Login updateUser={updateUser} />}
            </Route>
